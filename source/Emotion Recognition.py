...
def _opencv():
    print("\n\n Please Wait. . . .")
    opencvProcess = subprocess.Popen("python /home/proxydhakal/Downloads/Emotion-Recognition-Using-SVMs-master/source/TrainClassifierandTestVideoFeed.py", shell=True)
...
if __name__ == "__main__":
    ...
    root = Tk.Tk()
    root.wm_title("Emotion Recognition Using SVM by Shekhar Dahkal")
    ...
    authorString = "\n\n Developed By: " \
                   "\n Shekhar Dhakal" \
                   "\n (proxydhakal@outlook.com) " \
                   "\n Python 3.6.5, OpenCV, Skitlearn"     # Initial print
