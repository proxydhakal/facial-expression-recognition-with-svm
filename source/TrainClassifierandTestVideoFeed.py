...
print("\n\n Please Wait . . . . .\n\n")
# The dataset used in this example is Olivetti Faces:http://cs.nyu.edu/~roweis/data/olivettifaces.mat
...
gray1, face1 = detectFaces(cv2.imread("../data/Test_gray1.jpg"))
gray2, face2 = detectFaces(cv2.imread("../data/Test_gray2.jpg"))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cv2.imshow('FER System Live Testing', frame)
